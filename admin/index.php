...
<body>
  ...
  <div class="img align-middle text-center">
    <img src="gambar/Modern Initial MB Logo.png" alt="gambar" style="height: 300px;">
  </div>
  ...
  <div class="container" style="text-align: center;">
    <table style="margin: 0 auto;">
      ...
      <tr style="margin-top: 100px;">
        <td>
          <button type="button" class="btn btn-danger form-control" style="padding: 50px;">Transportation <br>
            <span style="font-size: 8px;">Open In New Tab</span></button>
        </td>
        <td>
          <button type="button" class="btn btn-warning form-control" style="padding: 50px;color: aliceblue;">Reservation <br>
            <span style="font-size: 8px;">Open In New Tab</span></button>
        </td>
      </tr>
      <tr>
